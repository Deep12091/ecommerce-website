        ...
        <div class="mx-auto container">
		    <form id="edit-image-form" enctype="multipart/form-data" method="POST" action="update_images.php">
                ...
                <div class="form-group mt-2">
                    <label>Image 1</label>
				    <input type="file" class="form-control" id="product_image1" value="<?php echo $product['product_image']; ?>" name="image1" placeholder="image 1" required/>
			    </div>
                ...
                <input type="submit" class="btn btn-primary" name="update-images" value="Update"/>
