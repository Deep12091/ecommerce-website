...
}else if(isset($_POST['edit-order'])){
    ...
    $stmt->bind_param('si',$order_status,$order_id);
        ...
        if($stmt->execute()){ 
            header('location: index.php?order_updated=order has been updated Successfully');  
                ...
                header('location: products.php?order_failed=Something went Wrong');
        }
        ...
        <div class="table-responsive">
            ...
            <div class="mx-auto container">
                ...
                <?php foreach($order as $r){ ?>
                    ...
                    <div class="form-group mt-3">
                        <input type="submit" class="btn btn-primary" name="edit-order" value="Edit"/>
			        </div>
